...
import com.example.androidpangea.views.subviews.ToggleIconButton
...
//        PostImage(imageUrl = post.postImage)
        ...
        Row(
            ...
            ToggleIconButton(
                ...
                enableIcon = painterResource(id = R.drawable.ic_profile),
                disableIcon = painterResource(id = R.drawable.ic_profile),
